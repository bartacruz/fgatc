...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ATC.last_order_date'
        db.add_column(u'atc_atc', 'last_order_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ATC.last_order_date'
        db.delete_column(u'atc_atc', 'last_order_date')
    ...
    models = {
        ...
        u'atc.tag': {
            ...
            'atc': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tags'", 'to': u"orm['atc.ATC']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
