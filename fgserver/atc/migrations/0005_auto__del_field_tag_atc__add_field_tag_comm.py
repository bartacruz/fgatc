...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tag.atc'
        db.delete_column(u'atc_tag', 'atc_id')

        # Adding field 'Tag.comm'
        db.add_column(u'atc_tag', 'comm',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='tags', to=orm['fgserver.Comm']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Tag.atc'
        raise RuntimeError("Cannot reverse this migration. 'Tag.atc' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Tag.atc'
        db.add_column(u'atc_tag', 'atc',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='tags', to=orm['atc.ATC']),
                      keep_default=False)
    ...
    models = {
        ...
        u'atc.tag': {
            ...
            'comm': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tags'", 'to': u"orm['fgserver.Comm']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
