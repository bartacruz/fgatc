...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Aircraft.freq'
        db.alter_column(u'fgserver_aircraft', 'freq', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Aircraft.freq'
        db.alter_column(u'fgserver_aircraft', 'freq', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))
