...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Comm'
        db.create_table(u'fgserver_comm', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('airport', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comms', to=orm['fgserver.Airport'])),
            ('type', self.gf('django.db.models.fields.IntegerField')()),
            ('frequency', self.gf('django.db.models.fields.IntegerField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('identifier', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal(u'fgserver', ['Comm'])


    def backwards(self, orm):
        # Deleting model 'Comm'
        db.delete_table(u'fgserver_comm')
    ...
    models = {
        ...
        u'fgserver.order': {
            ...
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'orders'", 'to': u"orm['fgserver.Airport']"})
        },
        u'fgserver.request': {
