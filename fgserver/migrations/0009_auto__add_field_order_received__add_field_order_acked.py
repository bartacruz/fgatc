...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.received'
        db.add_column(u'fgserver_order', 'received',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Order.acked'
        db.add_column(u'fgserver_order', 'acked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.received'
        db.delete_column(u'fgserver_order', 'received')

        # Deleting field 'Order.acked'
        db.delete_column(u'fgserver_order', 'acked')
