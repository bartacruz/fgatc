...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Runway.lat'
        db.add_column(u'fgserver_runway', 'lat',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=6),
                      keep_default=False)

        # Adding field 'Runway.lon'
        db.add_column(u'fgserver_runway', 'lon',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Runway.lat'
        db.delete_column(u'fgserver_runway', 'lat')

        # Deleting field 'Runway.lon'
        db.delete_column(u'fgserver_runway', 'lon')
