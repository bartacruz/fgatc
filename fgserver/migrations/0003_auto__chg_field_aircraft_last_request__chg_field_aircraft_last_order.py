...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Aircraft.last_request'
        db.alter_column(u'fgserver_aircraft', 'last_request', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

        # Changing field 'Aircraft.last_order'
        db.alter_column(u'fgserver_aircraft', 'last_order', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

    def backwards(self, orm):

        # Changing field 'Aircraft.last_request'
        db.alter_column(u'fgserver_aircraft', 'last_request', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Aircraft.last_order'
        db.alter_column(u'fgserver_aircraft', 'last_order', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
